...
class GVAR(RscDisplay) {
    idd = -1;
    movingEnable = 1;
    onLoad = "SETUVAR(QQGVAR(display),_this select 0)";
    class controls {
        class GVAR(displayGroup): RscControlsGroupNoHScrollbars {
            ...
            class controls {
                class Title: RscText {
                    ...
                    w = "POS_W(44.2)";
                    h = "POS_H(1)";
                    colorBackground[] = {"GETPRVAR('GUI_BCG_RGB_R',0.13)", "GETPRVAR('GUI_BCG_RGB_G',0.54)", "GETPRVAR('GUI_BCG_RGB_B',0.21)", "GETPRVAR('GUI_BCG_RGB_A',0.8)"};
