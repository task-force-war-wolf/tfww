class RscNotepad {
    ...
    onLoad = "[""onLoad"",_this,""RscNotepad"",'TFWWisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscNotepad"",'TFWWisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onMouseButtonDown = "\
