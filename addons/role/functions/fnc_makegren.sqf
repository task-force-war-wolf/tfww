...
if (hasinterface) then {
    ...
    player setVariable ["diwako_dui_radar_customIcon", "\a3\ui_f\data\map\vehicleicons\iconmanexplosive_ca.paa", true];

    // middle icon for indicators (available since 1.6.0)
    player setVariable ["diwako_dui_indicators_customIcon", "\a3\ui_f\data\map\vehicleicons\iconmanexplosive_ca.paa", true];
