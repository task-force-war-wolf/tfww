/*
Function name:TFWW_fnc_TFWW_fnc_AmmoCrate;
Author: Mr H.
...
Example(s):
[this,10,true,true] call TFWW_fnc_AmmoCrate;
*/
...
_box setVariable ["TFWW_AmmoMagazines", _allMagazinesType];

_handlerIndex = _box addEventHandler
 ["ContainerOpened",
  {
  _box = _this select 0;
  _allMagazinesType = _box getVariable "TFWW_AmmoMagazines";



  clearMagazineCargoGlobal _box;
  {_box addMagazineCargoGlobal [_x,10];} forEach _allMagazinesType;
      _box addItemCargoGlobal ["TFWW_medbags_FirstAid",2];
      _box addItemCargoGlobal ["TFWW_medbags_MedicKit",4];
...
_box setVariable ["TFWW_AmmoCrateEHIndex", _handlerIndex, true];
...
_box setVariable ["TFWW_AmmoCrateParameters", _params, true];
...
_statement =
 ...
 _box = _this select 0;
 _params = _box getVariable "TFWW_AmmoCrateParameters";
 [[_params],
  {
  params ["_params"];
  _box = _params select 0;
  _handlerIndex = _box getVariable "TFWW_AmmoCrateEHIndex";
  ...
  _params call TFWW_fnc_AmmoCrate;
  }
