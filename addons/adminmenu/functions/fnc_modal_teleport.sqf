...
_ctrlMap ctrlSetPosition [_ctrlGrpX, _ctrlGrpY, _ctrlGrpWidth, _ctrlGrpHeight - (2.2 * TFWW_ADMINMENU_STD_HEIGHT)];
        ...
        [{
            ...
            if (_unit isKindOf "CAManBase") then { // humans
                if (_isParadropped) then {
                    ...
                    "[Task Force War Wolf  Admin Menu] You were paradropped" remoteExec ["systemChat", _unit];
                } else {
                    _unit setVehiclePosition [_pos, [], 0, "FORM"];
                    "[Task Force War Wolf  Admin Menu] You were teleported" remoteExec ["systemChat", _unit];
                };
            } else { // vehicles
                ...
                "[Task Force War Wolf  Admin Menu] Your vehicle was teleported" remoteExec ["systemChat", _crew];
            };
        }, 0.1, [_pos, +GVAR(utilityData)]] call CBA_fnc_addPerFrameHandler;

        systemChat format ["[Task Force War Wolf  Admin Menu] Teleported %1 players", _numPlayers];
...
_ctrlCheckDrawAllSides ctrlSetPosition [_ctrlGrpX, _ctrlGrpY + _ctrlGrpHeight - (2.2 * TFWW_ADMINMENU_STD_HEIGHT), TFWW_ADMINMENU_STD_WIDTH, TFWW_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelDrawAllSides ctrlSetPosition [_ctrlGrpX + TFWW_ADMINMENU_STD_WIDTH, _ctrlGrpY + _ctrlGrpHeight - (2.2 * TFWW_ADMINMENU_STD_HEIGHT), (0.2 * _ctrlGrpWidth) - TFWW_ADMINMENU_STD_WIDTH, TFWW_ADMINMENU_STD_HEIGHT];
_ctrlLabelDrawAllSides ctrlCommit 0;
_ctrlLabelDrawAllSides ctrlSetText "Draw enemy units on map";

//private _paradropCheckX = (ctrlPosition _ctrlLabelDrawAllSides) select 0 + ctrlTextWidth _ctrlLabelDrawAllSides + TFWW_ADMINMENU_STD_WIDTH;
...
_ctrlCheckParadropInfantry ctrlSetPosition [_ctrlGrpX + (0.2 * _ctrlGrpWidth), _ctrlGrpY + _ctrlGrpHeight - (2.2 * TFWW_ADMINMENU_STD_HEIGHT), TFWW_ADMINMENU_STD_WIDTH, TFWW_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelParadropInfantry ctrlSetPosition [_ctrlGrpX + (0.2 * _ctrlGrpWidth) + TFWW_ADMINMENU_STD_WIDTH, _ctrlGrpY + _ctrlGrpHeight - (2.2 * TFWW_ADMINMENU_STD_HEIGHT), (0.2 * _ctrlGrpWidth) - TFWW_ADMINMENU_STD_WIDTH, TFWW_ADMINMENU_STD_HEIGHT];
...
_ctrlHint ctrlSetPosition [_ctrlGrpX, _ctrlGrpY + _ctrlGrpHeight - TFWW_ADMINMENU_STD_HEIGHT, 0.8 * _ctrlGrpWidth, TFWW_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlSetPosition [_ctrlGrpX + 0.8 * _ctrlGrpWidth, _ctrlGrpY + _ctrlGrpHeight - TFWW_ADMINMENU_STD_HEIGHT, 0.2 * _ctrlGrpWidth, TFWW_ADMINMENU_STD_HEIGHT];
