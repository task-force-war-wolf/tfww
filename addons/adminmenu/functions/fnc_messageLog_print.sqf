...
/* ----------------------------------------------------------------------------
Internal Function: TFWW_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call TFWW_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_TFWW_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[Task Force War Wolf  Adminmenu] Printed entry: %1%2",
