...
if (count _spokenLangs == 0) exitWith {
    systemChat "[Task Force War Wolf  Admin Menu] Failed to assign ACRE2 languages";
};
...
systemChat "[Task Force War Wolf  Admin Menu] New ACRE2 babel language(s) assigned";
