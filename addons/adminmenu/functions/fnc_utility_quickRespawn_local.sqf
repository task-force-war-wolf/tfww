...
if (_oldUnitdata isEqualType []) then {
    ...
    //         if (isNil "tfww_acre2_networksCreated") exitWith {}; //Ensure presets are created
    ...
    systemChat "[Task Force War Wolf  Admin Menu] Quick Respawn failed: old unit data unavailable";
};
