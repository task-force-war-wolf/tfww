...
//----------------------------------------------------------------------//
// Task Force War Wolf - adminMenu
force force tfww_adminMenu_endLogToRPT = true;
force force tfww_adminMenu_printToChat = 1;

// Task Force War Wolf - AI Disembark
force force tfww_ai_disembark_enabled = true;
force force tfww_ai_disembark_stayInImmobileChance = 0.2927;

// Task Force War Wolf - Back To Game
force force tfww_back_to_game_enableAddon = true;
force force tfww_back_to_game_removeBody = true;
...
// Task Force War Wolf - nvg
tfww_nvg_Blacklist = "";

// Task Force War Wolf - Pointing
force force tfww_pointing_vehicleEnabled = true;

// Task Force War Wolf - Safestart
force force tfww_safestart_startLocked = true;

// Task Force War Wolf - Spectator
force force tfww_spectator_allowAI = false;
force tfww_spectator_allowAIUnconscious = false;
force tfww_spectator_allowUnconscious = false;
force tfww_spectator_civilianSide = false;
force tfww_spectator_civilianSideUnconscious = false;
force force tfww_spectator_enabled = false;
force tfww_spectator_freeCamera = false;
force tfww_spectator_freeCameraUnconscious = false;
force tfww_spectator_sides = 0;
force tfww_spectator_sidesUnconscious = 0;
force tfww_spectator_TPPCamera = false;
force tfww_spectator_TPPCameraUnconscious = false;
force tfww_spectator_unconsciousDelay = 30;

// Task Force War Wolf - Suppress
force force tfww_suppress_checkLOS = true;
force force tfww_suppress_overlayFadeoutTime = 10;
force force tfww_suppress_overlayOpacity = 0.96;
force force tfww_suppress_overlayTexture = 0;
force force tfww_suppress_projectileMaxDistance = 9;
force force tfww_suppress_shooterMinDistance = 0;

// Task Force War Wolf - Tagging
force force tfww_tagging_enabled = true;

// Task Force War Wolf - tfar_setter
force force tfww_tfar_setter_airProfile = "None";
force force tfww_tfar_setter_crewStatusDefault = true;
force force tfww_tfar_setter_enableAllInteractions = true;
force force tfww_tfar_setter_enableArsenalAutoSettings = true;
force force tfww_tfar_setter_enableCompatFK = true;
force force tfww_tfar_setter_enableLRInteractions = true;
force force tfww_tfar_setter_enableMountingAutoSettings = true;
force force tfww_tfar_setter_enableSRAndLRInteractions = true;
force force tfww_tfar_setter_enableSRInteractions = true;
force force tfww_tfar_setter_enableVLRInteractions = true;
force force tfww_tfar_setter_landProfile = "None";

// Task Force War Wolf - Towing
force force tfww_towing_addToCars = true;
force force tfww_towing_addToHeavyDutyVehicles = true;
...
force force ace_advanced_fatigue_loadFactor = 0.459135;
force force ace_advanced_fatigue_performanceFactor = 5;
force force ace_advanced_fatigue_recoveryFactor = 5;
force force ace_advanced_fatigue_swayFactor = 0.566745;
force force ace_advanced_fatigue_terrainGradientFactor = 0.423267;
...
force force ace_casings_maxCasings = 150;
...
// ACE G-Forces
force force ace_gforces_coef = 0.0990013;
...
force force ace_interact_menu_colorTextMax = [1,0.715967,0,1];
force force ace_interact_menu_colorTextMin = [1,0.744662,0,0.694444];
...
force force ace_interact_menu_menuBackground = 2;
force force ace_interact_menu_menuBackgroundSelf = 2;
...
force force ace_medical_deathChance = 0.75;
...
force force ace_medical_ivFlowRate = 3.5;
...
force force ace_medical_statemachine_cardiacArrestTime = 840;
...
force force ace_nametags_defaultNametagColor = [0.163567,1,1,1];
...
force force ace_nightvision_effectScaling = 0.0688704;
...
force force ace_finger_indicatorColor = [0.83,0.665748,0,1];
